...
public class AStarMaze extends JFrame implements Runnable, MouseListener, MouseMotionListener, KeyListener {
    ...
    public AStarMaze () {
        ...
        FilePath = "/Users/georgea.e/Documents/Second Year 2/Next Gen game dev/Assignment 9/BadGuy/src";
        System.out.println("Working Directory = " + FilePath);

        // load raster graphics and instantiate game objects
        ImageIcon icon = new ImageIcon("/Users/georgea.e/Documents/Second Year 2/Next Gen game dev/Assignment 9/BadGuy/src/badguy.png");
        Image img = icon.getImage();
        badguy = new BadGuy(img);
        icon = new ImageIcon("/Users/georgea.e/Documents/Second Year 2/Next Gen game dev/Assignment 9/BadGuy/src/player.png");
        img = icon.getImage();
    ...
    public void paint(Graphics g) {
        ...
        badguy.paint(g);
            ...
            g.fillRect(15, 35, 70, 30);
            g.fillRect(315, 35, 70, 30);
            g.fillRect(415, 35, 70, 30);
